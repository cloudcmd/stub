export function stub<Args extends any[] = any[],>(fn?: (...args: Args) => unknown): Stub<Args, void>;

export type Stub<Args extends unknown[] = unknown[], Return = unknown,> = ((...args: Args) => Return) & {
    called: boolean;
    callId: number;
    args: Args[];
    callCount: number;
